...
export const PrettyDashIcon: React.FC<{
  fill?: string;
  size?: number;
}> = ({ fill, size }) => {
  return (
...
const PrettyReloadIcon: React.FC<{
  size?: number;
  fill?: string;
}> = ({ size, fill }) => {
  return (
...
const PrettyWorldIcon: React.FC<{ size?: number; fill?: string }> = ({
  size,
  fill,
}) => {
  return (
...
const PrettyLinkIcon: React.FC<{ size?: number; fill?: string }> = ({
  size,
  fill,
}) => {
  return (
