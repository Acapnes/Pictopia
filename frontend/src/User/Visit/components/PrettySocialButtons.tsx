...
const PrettySocialInstagramButton: React.FC<{ socialUrl: string }> = ({
  socialUrl,
}) => {
  return (
    <PrettySocialButton
      socialUrl={socialUrl}
      advStyle="bg-gradient-to-br from-[#ff8a05] via-[#ff5478] to-[#ff00c6] group-hover:from-[#ff00c6]
...
const PrettySocialGitHubButton: React.FC<{ socialUrl: string }> = ({
  socialUrl,
}) => {
  return (
    <PrettySocialButton socialUrl={socialUrl} advStyle="bg-slate-800">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
const PrettySocialLinkedInButton: React.FC<{ socialUrl: string }> = ({
  ...
  return (
    <PrettySocialButton socialUrl={socialUrl} advStyle="bg-blue-700">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
