  ...
  return (
    <>
      <div className="w-full z-30 sticky top-0">
        <div className="w-full flex flex-row space-x-2 items-center justify-between bg-rough-soft-black bg-opacity-95 px-3 py-2.5 text-sm">
          ...
          <div className="flex flex-row space-x-1 items-center">
            <PrettyHeaderUploadPicture user={userCredentials} />
...
const PrettyHeaderUploadPicture: React.FC<{ user: UserDto }> = ({ user }) => {
  return (
    <>
      {user?.email && (
        <PrettyRainbowLink
